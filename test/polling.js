...
var tests = [{
    ...
    firstResult: 1,
    firstPayload: {
        method: "core_newBlockFilter",
        params: []
    },
    secondResult: ['0x1234'],
    secondPayload: {
        method: "core_getFilterChanges"
    }
},
{
    protocol: 'core',
    ...
    firstResult: 1,
    firstPayload: {
        method: "core_newPendingTransactionFilter",
        params: []
    },
    secondResult: ['0x1234'],
    secondPayload: {
...
var testPolling = function (tests) {
    ...
    describe('vnt.core.filter.polling', function () {
        tests.forEach(function (test, index) {
            it('should create && successfully poll filter', function (done) {
                ...
                // when
                var filter = vnt[test.protocol].filter.apply(vnt[test.protocol], test.args);
